...
>(({ className, showIcon = false, ...props }, ref) => {
  // Lazy useState initializer (not useMemo) since Math.random() is impure -
  // useMemo's callback must be pure and may be re-invoked by React; a lazy
  // initializer is documented as the correct place for one-time impure work.
